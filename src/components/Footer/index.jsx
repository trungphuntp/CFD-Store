                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-lg-2">
                            <div className="widget">
                                ...
                                <ul className="widget-list">
                                    <li>
                                        <Link to={PATH.PAYMENT}>Payment Methods</Link>
                                    </li>
                                    <li>
                                        <Link to={PATH.RETURNS}>Returns</Link>
                                    </li>
                                    <li>
                                        <Link to={PATH.SHIPPING}>Shipping</Link>
                                    </li>
                                    <li>
                        ...
                        <div className="col-sm-6 col-lg-2">
                            <div className="widget">
                                ...
                                <ul className="widget-list">
                                    <li>
                                        <Link to={PATH.DASHBOARD.INDEX}>Account Details</Link>
                                    </li>
                                    <li>
                                        <Link to={PATH.CART}>View Cart</Link>
                                    </li>
                                    <li>
                                        <Link to={PATH.DASHBOARD.WISHLIST}>My Wishlist</Link>
                                    </li>
                                    <li>
                                        <Link to={PATH.DASHBOARD.ODER}>Track My Order</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
